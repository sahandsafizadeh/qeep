...
func TestSimple(t *testing.T) {
	tensor.RunTestLogicOnDevices(func(dev tensor.Device) {
		...
		expy, err := tensor.TensorOf([]float64{0}, conf)
		if err != nil {
			t.Fatal(err)
		}
		...
		expy, err = tensor.TensorOf([]float64{1}, conf)
		if err != nil {
			t.Fatal(err)
		}
		...
		expy, err = tensor.TensorOf([]float64{0, 1}, conf)
		if err != nil {
			t.Fatal(err)
		}
		...
		expy, err = tensor.TensorOf([]float64{0, 1, 0}, conf)
		if err != nil {
			t.Fatal(err)
		}
		...
		expy, err = tensor.TensorOf([]float64{1, 0}, conf)
		if err != nil {
			t.Fatal(err)
		}
		...
		expy, err = tensor.TensorOf([]float64{0, 1, 0, 1}, conf)
		if err != nil {
			t.Fatal(err)
		}
		...
		expy, err = tensor.TensorOf([]float64{0, 1, 0, 1, 0}, conf)
		if err != nil {
			t.Fatal(err)
		}
