...
func TestSum(t *testing.T) {
	runTestLogicOnDevices(func(dev qti.Device) {
		...
		ten, err = qti.Ones([]int32{3, 4, 5}, conf)
		if err != nil {
			t.Fatal(err)
		}
		...
		exp, err = qti.Full([]int32{4, 5}, 3., conf)
		if err != nil {
			t.Fatal(err)
		}
		...
		exp, err = qti.Full([]int32{3, 5}, 4., conf)
		if err != nil {
			t.Fatal(err)
		}
		...
		exp, err = qti.Full([]int32{3, 4}, 5., conf)
		if err != nil {
			t.Fatal(err)
		}
...
func TestAvg(t *testing.T) {
	runTestLogicOnDevices(func(dev qti.Device) {
		...
		ten, err = qti.Full([]int32{3}, 2., conf)
		if err != nil {
			t.Fatal(err)
		}
		...
		ten, err = qti.Full([]int32{3, 4, 5}, 3., conf)
		if err != nil {
			t.Fatal(err)
		}
		...
		ten, err = qti.Full([]int32{3, 4, 5}, 4., conf)
		if err != nil {
			t.Fatal(err)
		}
		...
		ten, err = qti.Full([]int32{3, 4, 5}, 5., conf)
		if err != nil {
			t.Fatal(err)
		}
...
func TestVar(t *testing.T) {
	runTestLogicOnDevices(func(dev qti.Device) {
		...
		ten, err = qti.Full([]int32{3}, 5., conf)
		if err != nil {
			t.Fatal(err)
		}
...
func TestValidationReducers(t *testing.T) {
	runTestLogicOnDevices(func(dev qti.Device) {
		...
		ten, err = qti.Zeros([]int32{3, 1}, conf)
		if err != nil {
			t.Fatal(err)
		}
